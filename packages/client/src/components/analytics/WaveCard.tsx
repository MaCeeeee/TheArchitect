      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            <span className="text-[10px] font-bold text-[#00ff41] bg-[#0a1a0a] px-1.5 py-0.5 rounded">
              W{wave.waveNumber}
            </span>
            <span className="text-xs font-medium text-white truncate">{wave.name}</span>
          </div>
      ...
      {expanded && (
        <div className="px-3 pb-3 space-y-3 border-t border-[var(--border-subtle)]">
          ...
          <div className="space-y-1">
            ...
            {wave.elements.map((el) => (
              ...
              >
                ...
                />
                <span className="text-[11px] text-white flex-1 truncate">{el.name}</span>
          ...
          {wave.riskMitigations && wave.riskMitigations.length > 0 && (
            <div className="space-y-1">
              <div className="text-[10px] font-medium text-[#f59e0b] flex items-center gap-1">
          ...
          {wave.stakeholderNotes && (
            <div className="flex gap-2 p-2 rounded bg-[#1a1a0a] border border-[#2a2a1a]">
              <Users size={12} className="text-[#f59e0b] shrink-0 mt-0.5" />
              <p className="text-[10px] text-[#b0b080] leading-relaxed">{wave.stakeholderNotes}</p>
            </div>
          )}
        </div>
      )}
