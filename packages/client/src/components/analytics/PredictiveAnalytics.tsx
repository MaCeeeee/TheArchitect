  ...
  return (
    <div className="flex flex-col h-full overflow-y-auto">
      <div className="p-3 border-b border-[var(--border-subtle)]">
        ...
        <p className="text-[10px] text-[var(--text-tertiary)] mt-1">Architecture health and Monte Carlo simulation</p>
      </div>

      {/* Health metrics */}
      <div className="p-3 space-y-3">
        <h4 className="text-[10px] font-semibold uppercase text-[var(--text-tertiary)] flex items-center gap-1">
        ...
        <div className="rounded-md border border-[var(--border-subtle)] bg-[var(--surface-base)] p-3">
          <div className="flex items-center justify-between mb-2">
            <span className="text-[10px] text-[var(--text-secondary)]">Completeness</span>
          ...
          <div className="space-y-2">
            <div className="grid grid-cols-3 gap-1">
              <div className="rounded-md border border-[var(--border-subtle)] bg-[var(--surface-base)] p-1.5 text-center">
                <div className="text-[9px] text-[var(--text-tertiary)]">P10 (Best)</div>
              ...
              <div className="rounded-md border border-[#00ff41]/30 bg-[#00ff41]/10 p-1.5 text-center">
                <div className="text-[9px] text-[var(--text-tertiary)]">P50 (Median)</div>
                <div className="text-xs font-bold text-white">{formatCost(simResult.p50)}</div>
              </div>
              <div className="rounded-md border border-[var(--border-subtle)] bg-[var(--surface-base)] p-1.5 text-center">
                <div className="text-[9px] text-[var(--text-tertiary)]">P90 (Worst)</div>
            ...
            <div className="rounded-md border border-[var(--border-subtle)] bg-[var(--surface-base)] p-2">
              <div className="text-[9px] text-[var(--text-tertiary)] mb-1">Cost Distribution (5K iterations)</div>
              ...
              <div className="flex justify-between mt-1">
                <span className="text-[8px] text-[var(--text-disabled)]">{formatCost(simResult.p10)}</span>
                <span className="text-[8px] text-[var(--text-disabled)]">{formatCost(simResult.p90)}</span>
              </div>
            </div>
