    ...
    <div className="flex flex-col h-full overflow-y-auto">
      ...
      <div className="grid grid-cols-2 gap-2 p-3">
        <div className="rounded-md border border-[#334155] bg-[#0f172a] p-2">
          <div className="flex items-center gap-1.5 mb-1">
            ...
            <span className="text-[10px] text-[#64748b]">Avg Utilization</span>
          </div>
        ...
        <div className="rounded-md border border-[#334155] bg-[#0f172a] p-2">
          <div className="flex items-center gap-1.5 mb-1">
            ...
            <span className="text-[10px] text-[#64748b]">Bottlenecks</span>
          </div>
      ...
      <div className="px-3 pb-3">
        ...
        <div className="space-y-2">
          {capacityData.items.map((item, i) => (
            <div key={i} className="rounded-md border border-[#334155] bg-[#0f172a] p-2">
              ...
              <div className="flex items-center gap-2 mt-1">
                <span className="text-[8px] text-[#475569] capitalize">{item.type.replace(/_/g, ' ')}</span>
                <span className="text-[8px] text-[#475569]">{item.currentLoad}/{item.maxCapacity} load</span>
                <span className={`text-[8px] ${item.trend === 'growing' ? 'text-[#ef4444]' : item.trend === 'declining' ? 'text-[#22c55e]' : 'text-[#64748b]'}`}>
      ...
      {capacityData.items.length === 0 && (
        <div className="flex-1 flex items-center justify-center p-6">
          <p className="text-xs text-[#64748b] text-center">No infrastructure elements</p>
        </div>
      )}
    </div>
  );
