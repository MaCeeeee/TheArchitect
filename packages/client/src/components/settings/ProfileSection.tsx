...
export default function ProfileSection() {
  ...
  return (
    <div>
      ...
      <p className="text-sm text-[var(--text-tertiary)] mb-6">Manage your public profile information.</p>
      ...
      <div className="space-y-5">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div className="flex-1">
            <label className="block text-sm font-medium text-[var(--text-secondary)] mb-1">Avatar URL</label>
            <input
              type="url"
              value={avatarUrl}
        ...
        <div>
          ...
          <input
            ...
            value={profile?.email || ''}
            disabled
            className="w-full rounded-md border border-[var(--border-subtle)] bg-[var(--surface-base)] px-3 py-2 text-sm text-[var(--text-tertiary)] outline-none cursor-not-allowed"
          />
          <p className="text-xs text-[var(--text-disabled)] mt-1">Email cannot be changed.</p>
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full rounded-md border border-[var(--border-subtle)] bg-[var(--surface-base)] px-3 py-2 text-sm text-white placeholder:text-[var(--text-tertiary)] outline-none focus:border-[#00ff41] resize-none"
          />
        </div>
