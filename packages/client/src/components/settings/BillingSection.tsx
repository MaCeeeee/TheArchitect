...
export default function BillingSection() {
  ...
  if (!billing) {
    return <div className="text-sm text-[#64748b]">Loading billing information...</div>;
  }

  const planColors: Record<string, string> = {
    free: 'text-[#94a3b8]',
    professional: 'text-[#7c3aed]',
  ...
  return (
    <div>
      ...
      <p className="text-sm text-[#64748b] mb-6">View your current plan and features.</p>
      ...
      <div className="rounded-lg border border-[#334155] bg-[#1e293b] p-6">
        ...
        <div className="mb-6">
          <p className="text-sm text-[#94a3b8] mb-1">Role</p>
