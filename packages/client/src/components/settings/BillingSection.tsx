...
export default function BillingSection() {
  ...
  if (!billing) {
    return <div className="text-sm text-[var(--text-tertiary)]">Loading billing information...</div>;
  }
  ...
  return (
    <div>
      ...
      <p className="text-sm text-[var(--text-tertiary)] mb-6">View your current plan and features.</p>

      <div className="rounded-lg border border-[var(--border-subtle)] bg-[var(--surface-raised)] p-6">
