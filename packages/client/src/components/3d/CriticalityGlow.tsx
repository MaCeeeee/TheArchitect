...
const colorForScore = (score: number): { color: string; pulseSpeedHz: number } => {
  if (score >= 90) return { color: '#ef4444', pulseSpeedHz: 1 / 1.5 };
  if (score >= 70) return { color: '#f97316', pulseSpeedHz: 1 / 2.0 };
  if (score >= 50) return { color: '#eab308', pulseSpeedHz: 1 / 3.0 };
