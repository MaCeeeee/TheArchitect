...
// Per-law convenience factories (nis2EurLexSource, dsgvoEurLexSource,
// aiActEurLexSource, dataActEurLexSource, EurLexNis2Source) were removed in
// THE-418 (.6-Kern): source-registry.ts now builds `EurLexSource` instances
// generically from `crawl-config.ts` (SOURCE_CRAWL_CONFIG) — a new law is a
// data row there, not a new factory function here.
