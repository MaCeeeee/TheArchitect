...
> **Geprüft und als Regel VERWORFEN — THE-547, noch am selben Tag.** Der Gegenstand wurde als eigener Slot extrahiert (290 Anforderungen, 0 unlesbar), bottom-up zu 30 Klassen verdichtet (223 Rohwerte, Kompression 7,4:1) und als **Gleichheitsbedingung** in die Gruppierung gezogen. Ergebnis gegen die vorab gesetzten Schwellen: alle 10 Ablehnungen lösen sich auf ✅, aber **19 von 22 Annahmen** gehen mit ❌ und die Gold-Quote fällt auf 2/5 ❌. Übereinstimmung mit dem Menschen **40,6 %** gegenüber 68,8 % auf der Handlung allein. **Der Gegenstand als Gleichheitsregel macht es schlechter.** Die zerschlagenen Annahmen paaren *benachbarte* Gegenstände („IKT-Vorfall" mit „Datenschutzverletzung", „IKT-Revision" mit „IKT-Governance") — der Katalog trennt fachlich korrekt, der Adjudikator zieht für die Maßnahmenfrage zusammen; zwei vertretbare Urteile auf verschiedenen Granularitätsebenen. **Es bleibt bei E4 in der ursprünglichen Form: geteilt wird auf der Handlung.** Ob eine *typisierte Beziehung* zwischen Gegenständen (statt Gleichheit) trägt, ist offen und auf 32 Fällen nicht prüfbar. Beleg: `docs/evals/reqtrace-capability.md`.
